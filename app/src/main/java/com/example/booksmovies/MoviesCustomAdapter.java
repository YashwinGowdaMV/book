...
public class MoviesCustomAdapter extends RecyclerView.Adapter<MoviesCustomAdapter.MyViewHolder> {
    ...
    MoviesCustomAdapter(Activity activity, Context context, ArrayList<String> ids, ArrayList<String> names, ArrayList<String> dates,
                        ArrayList<String> comments, ArrayList<String> ratings) {
    ...
    @NonNull
    @Override
    public MoviesCustomAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.movies_list_item, parent, false);
        return new MoviesCustomAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MoviesCustomAdapter.MyViewHolder holder, int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            layout = itemView.findViewById(R.id.movies_layout);
        }
    }
}
